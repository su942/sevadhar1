...
import { ArrowLeft, Sparkles, MapPin, ShieldCheck, Zap, Star, Search, X } from 'lucide-react';
                        ...
                        return (
                            <div key={s.id} className="group bg-white p-4 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-orange-100 transition-all flex gap-4 items-center">
                                <div className="w-24 h-24 rounded-xl overflow-hidden shrink-0 bg-gray-100">
                                    <img src={s.image} loading="lazy" alt={s.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                </div>
                ...
                {cartItems.length > 0 && (
                    <div className="fixed bottom-24 left-4 right-4 z-[60] md:bottom-8 md:left-auto md:right-8 md:w-96 animate-in slide-in-from-bottom-10 fade-in duration-300">
                        <button
                            ...
                            aria-label={`View cart with ${cartStore.getItemCount()} items totaling ₹${cartStore.getTotalAmount()}`}
                        >
    ...
    return (
        <div className="animate-in fade-in duration-500 pb-20">
            ...
            <div className="mb-6">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-12 py-4 bg-white border border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#FF6B35] focus:border-transparent text-gray-900 placeholder-gray-500"
                    />
                    {localSearchQuery && (
                        <button
            ...
            <div className="relative mb-10 group overflow-x-auto no-scrollbar flex gap-4 snap-x pb-4">
                <div className="min-w-[85%] md:min-w-[60%] snap-center relative rounded-3xl overflow-hidden h-48 md:h-64 bg-gray-900 text-white shadow-xl flex-shrink-0 cursor-pointer hover:shadow-2xl transition-all" onClick={() => setSelectedCategoryId('cleaning')}>
                    <img src="https://images.unsplash.com/photo-1581578731117-104f2a863a30?auto=format&fit=crop&q=80&w=1000" loading="lazy" alt="Home Cleaning Service" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-700" />
                ...
                <div className="min-w-[85%] md:min-w-[60%] snap-center relative rounded-3xl overflow-hidden h-48 md:h-64 bg-blue-900 text-white shadow-xl flex-shrink-0 cursor-pointer hover:shadow-2xl transition-all" onClick={() => setSelectedCategoryId('ac_repair')}>
                    <img src="https://images.unsplash.com/photo-1621905476059-5f34604809b6?auto=format&fit=crop&q=80&w=1000" loading="lazy" alt="AC Service" className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-700" />
            ...
            {!selectedLocation && (
                <div className="bg-red-50 border border-red-100 text-red-800 px-4 py-3 rounded-xl mb-8 flex items-center gap-3 animate-pulse" role="alert">
                    <MapPin size={20} />
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-10 border border-gray-100">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex items-center gap-4 group cursor-pointer">
                        <div className="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center text-green-600 group-hover:scale-110 transition-transform">
                            <ShieldCheck size={24} />
                        </div>
                        <div>
                            <h4 className="font-bold text-gray-900 group-hover:text-green-600 transition-colors">Sevadhar Safety</h4>
                    ...
                    <div className="flex items-center gap-4 group cursor-pointer">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Instant Connect</h4>
                            <p className="text-xs text-gray-500">Response in 60 secs</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 group cursor-pointer">
                        <div className="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center text-orange-600 group-hover:scale-110 transition-transform">
                            <Star size={24} />
                        </div>
                        <div>
                            <h4 className="font-bold text-gray-900 group-hover:text-orange-600 transition-colors">Top Rated</h4>
